...
public class HandleDeliveryCFPBehaviour extends CyclicBehaviour {
    private final DeliveryAgent deliveryAgent;
    static final ObjectMapper mapper = new JsonMapper();
    private final String CFP_KEY;
    private final String REPLY_KEY;
    public HandleDeliveryCFPBehaviour(DeliveryAgent a, String cfp_key, String reply_key) {
        deliveryAgent = a;
        CFP_KEY = cfp_key;
        REPLY_KEY = reply_key;
    }
